                        ...
                        <c:forEach items="${listcate}" var="cate" varStatus="STT">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img class="table-image" src="${imgUrl}" alt="${cate.categoryname}" />
                                </td>
                                ...
                                <td>
                                    <a href="<c:url value='/admin/category/edit?id=${cate.categoryId}'/>" class="text-decoration-none text-info">Sửa</a> |
                                    <a href="<c:url value='/admin/category/delete?id=${cate.categoryId}'/>" class="text-decoration-none text-info" onclick="return confirm('Bạn có chắc chắn muốn xóa?');">Xóa</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
