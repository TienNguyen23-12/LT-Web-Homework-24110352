...
<div class="container">
    <div class="main-content text-center">
        <h2>Xin chào Admin: <strong>${sessionScope.account.fullName}</strong></h2>
        <hr>
        <div class="text-left" style="max-width: 300px; margin: 0 auto;">
            <p><i class="fa fa-envelope text-primary"></i> <strong>Email:</strong> ${sessionScope.account.email}</p>
            <p><i class="fa fa-phone text-success"></i> <strong>SĐT:</strong> ${sessionScope.account.phone}</p>
        </div>
        <br>
