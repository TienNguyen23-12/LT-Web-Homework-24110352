...
<div class="container">
    <div class="main-content text-center">
        <h2>Chào mừng <strong>${sessionScope.account.fullName}</strong> đến với hệ thống!</h2>
        <p class="text-muted">Bạn đang đăng nhập với tư cách: <strong>Khách hàng (User)</strong></p>
        <br>
